...
export interface IHoneyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IHoney extends BaseContract {
  connect(runner?: ContractRunner | null): IHoney;
  waitForDeployment(): Promise<this>;

  interface: IHoneyInterface;
